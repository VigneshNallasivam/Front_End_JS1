...
function calculation() {
    ...
    let total_mark = document.getElementById("total_mark").value = total;
    console.log(total_mark);
    let avg_mark = document.getElementById("avg_mark").value = average;
    console.log(avg_mark);

    if (name === "" && register === "") {
        $(document).ready(function(){
            $("#english,#tamil,#maths,#science,#social").mouseenter(function(){
              $(this).hide();
            });
          });
        enableDisableCalculation(true);
        document.querySelector(".calculate_button").style.pointerEvents = "none";
    }
    ...
    switch (true) {
        ...
        case (total_mark >= 400 && total_mark < 500): {
        ...
        case (total_mark >= 400 && total_mark < 450): {
            document.getElementById("grade").value = "A+";
            document.getElementById("result").value = "PASS";
            break;
        }

        case (total_mark >= 300 && total_mark < 400): {
            document.getElementById("grade").value = "A";
            document.getElementById("result").value = "PASS";
            break;
        }

        case (total_mark >= 200 && total_mark < 300): {
            document.getElementById("grade").value = "B";
            document.getElementById("result").value = "PASS";
            break;
        }

        case (total_mark >= 175 && total_mark < 200): {
